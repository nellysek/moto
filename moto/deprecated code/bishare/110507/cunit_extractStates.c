...
CU_ASSERT(generate_value_Con_motor(FORWARD) == FORWARD); /*asserts for generate function I just check if the code is reacting as expected*/
...
CU_ASSERT(generate_value_Pan_motor(FORWARD) == FORWARD); /*asserts for generate function I just check if the code is reacting as expected*/
...
CU_ASSERT(generate_value_Pan_motor(INCREASE_MOTOR | LEFT_MOTOR) == INCREASE_MOTOR | LEFT_MOTOR); /*asserts for generate function I just check if the code is reacting as expected*/ 
...
CU_ASSERT(generate_value_Pan_motor(DECREASE_MOTOR | LEFT_MOTOR) == DECREASE_MOTOR | LEFT_MOTOR); /*asserts for generate function I just check if the code is reacting as expected*/ 
...
CU_ASSERT(generate_value_Inc_motor(INCREASE_MOTOR | LEFT_MOTOR) == INCREASE_MOTOR | LEFT_MOTOR);/*asserts for generate function I just check if the code is reacting as expected*/ 
...
CU_ASSERT(generate_value_Dec_motor(DECREASE_MOTOR | LEFT_MOTOR) == DECREASE_MOTOR | LEFT_MOTOR);/*asserts for generate function I just check if the code is reacting as expected*/ 
