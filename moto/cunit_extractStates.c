...
/* here we test the generate_value_Con_motor function */
...
CU_ASSERT(generate_value_Inc_motor(INCREASE_MOTOR) == LEFT_MOTOR);
CU_ASSERT(generate_value_Inc_motor(INCREASE_MOTOR) == RIGHT_MOTOR);
CU_ASSERT(generate_value_Inc_motor(INCREASE_MOTOR) == FRONT_MOTOR);
CU_ASSERT(generate_value_Inc_motor(INCREASE_MOTOR) == REAR_MOTOR);
...
/* add test for the states */
   ...
   CU_pSuite generate_value_Inc_motor = CU_add_suite("Increase states", NULL; NULL);
   test_check("Test increase_test");

   CU_add_test(generate_value_Inc_motor, "Test increase", test_increase);
   test_check("Test test_increase");
